...
function ContactScreen() {
    ...
    const formSubmit = (e) => {
        e.preventDefault();
        alert(
            `Your Full Name is ${data.fullName}. Your Email address ${data.email}, Your City is ${data.city}, Your message is ${data.message}. Thank you for your response.`
        );
    };
    ...
    return (
        <div>
            <section className="main_heading pt-5">
                ...
                <div className="container my-5" style={{ minHeight: "100vh", display: "flex", justifyContent: "center", alignItems: "center" }}>
                    <div className="row">
                        <div className="col-12 col-md-8 col-lg-6 mx-auto" style={{ maxWidth: "600px", width: "100%" }}>
