...
import DiabeticsScreen from "./screens/DiabeticsScreen";
    ...
    <Router>
      ...
      <main className="app">
        <Switch>
          ...
          <Route
            exact
            path="/products/dermatology"
            component={DermotologyScreen}
          />
          <Route
            exact
            path="/products/depression"
          ...
          <Route
            exact
            path="/products/diabetics"
            component={DiabeticsScreen}
          />
          <Route
            exact
            path="/products/womensCare"
            component={WomensCareScreen}
          />
